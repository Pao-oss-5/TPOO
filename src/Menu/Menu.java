...
public class Menu {
        ...
        while(opcion != 3) {
            ...
            switch (opcion){
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Has elegido ver pacientes");
                    break;
                case 3:
    ...
    private void mostrarMenu() {
        ...
        while(opcion != 9) {
            ...
            switch (opcion) {
                case 1:
                    System.out.println("Haz elegido la opcion REGISTRAR PACIENTE");
                    sc.nextLine();
                ...
                case 2:
                    System.out.println("Haz elegido la opcion REGISTRAR MEDICO");
                    sc.nextLine();
