        ...
        while(opcion != 9) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    Medicos medico = new Medicos(idMedico, nombreMedico, apellidoMedico, fechaNacimientoMedico, telefonoMedico, rfcMedico);
                    medico.setId(hospital.generarIDMedico(Medicos));
                    hospital.registrarMedico(Medicos);
                    break;
