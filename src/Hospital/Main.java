...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nBienvenido al programa de Gestion del hospital ");
        System.out.println("\nMENU");
        ...
        switch(opcion){
            ...
            case 3:
                ...
                switch(opcion4){
                    case 1:
                        System.out.println("Haz seleccionado registrar un paciente");
                        break;

                    case 2:
                        System.out.println("Haz seleccionado gestionar un paciente");
                        break;
                }
