...
public class Hospital {
    ...
    public Hospital.ValidadorHospital validador;

    public Hospital() {
        validador = new Hospital.ValidadorHospital();
    }
    ...
    public void registrarConsulta(Consulta consulta) {
        ...
        if (validador.validarDispolnibilidadEnFechaConsulta(consulta.getFechaHora(), consulta.getConsultorio().getNumeroConsultorio(), this.listaConsultas)) {
            if (!validador.validarDisponibilidadMedico(consulta.getFechaHora(),
    ...
    public String generarIDMedico(Medicos medico) {
    ...
    public <Consultorios> void mostrarConsultorioPorID(String id) {
        for (Consultorios consultorio : this.listaConsultorios) {
            if (!consultorio.getClass().equals(id)) {
                continue;
            }
            System.out.println(consultorio.getClass());
            return;
        }
    ...
    public class ValidadorHospital {
        public boolean validarDispolnibilidadEnFechaConsulta(String fechaHora, int numeroConsultorio, ArrayList<Consulta> listaConsultas) {
        }
    }
}